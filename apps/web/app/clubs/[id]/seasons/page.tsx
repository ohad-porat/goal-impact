...
const TeamSeasonContent = ({ team, season, competition, players, teamId, seasonId }: {
...
export default async function TeamSeasonPage({ params, searchParams }: TeamSeasonPageProps) {
  ...
  return <TeamSeasonContent team={team} season={seasonData} competition={competition} players={players} teamId={teamId} seasonId={seasonId} />
}
