...
export function ClubSeasonsTableHeader() {
  return (
    <thead className="bg-orange-400">
      <tr>
        <th className={`${tableStyles.compact.headerLeft} pl-6`}>Season</th>
        <th className={tableStyles.compact.headerLeft}>Competition</th>
        <th className={tableStyles.compact.header}>Tier</th>
        ...
        <th className={tableStyles.compact.header}>Attendance</th>
        <th className={tableStyles.compact.headerLeft}>Notes</th>
      </tr>
    </thead>
  )
}
