  ...
  return (
    <div>
      <div className="mb-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <h2 className="text-xl sm:text-2xl font-bold text-white">Career Totals Scatter Chart</h2>
        <select
          id="league-filter"
          ...
          <ResponsiveContainer width="100%" height={500}>
            <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
              ...
              <XAxis
                ...
                name="Total Goals"
                domain={xDomain}
                label={{ value: 'Total Goals', position: 'insideBottom', offset: -5, style: { fill: '#e2e8f0' } }}
                stroke="#cbd5e1"
              />
              <YAxis
                type="number"
                ...
                domain={yDomain}
                label={{ value: 'Total Goal Value', angle: -90, position: 'insideLeft', style: { fill: '#e2e8f0' } }}
                stroke="#cbd5e1"
              />
