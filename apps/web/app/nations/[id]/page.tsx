...
const NationDetailsContent = ({ nation, competitions, clubs, players }: {
...
export default async function NationShowPage({ params }: NationShowPageProps) {
  ...
  return <NationDetailsContent nation={nation} competitions={competitions} clubs={clubs} players={players} />
}
