        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-700 table-fixed">
            <thead className="bg-gray-700">
              <tr>
                <th className="pl-6 pr-3 py-3 text-left text-sm font-bold text-white uppercase tracking-wider">
                  Club
                </th>
                <th className="px-3 py-3 text-center w-32 whitespace-nowrap text-sm font-bold text-white uppercase tracking-wider">
                  Avg Pos
                </th>
              </tr>
            </thead>
                ...
                clubs.map((club) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-center w-32 whitespace-nowrap text-white">
                      {club.avg_position !== null &&
                      club.avg_position !== undefined
                        ? club.avg_position.toFixed(1)
                        : "-"}
                    </td>
                  </tr>
                ))
