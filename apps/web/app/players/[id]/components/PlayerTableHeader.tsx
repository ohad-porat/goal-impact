...
export function PlayerTableHeader() {
  ...
  return (
    <thead className="bg-gray-700">
      <tr>
        <th rowSpan={2} className={`${teamSeason.headerLeft} pl-3 w-[120px]`}>
          Season
        </th>
        <th rowSpan={2} className={`${teamSeason.headerLeft} pl-3 w-[200px]`}>
          Team
        </th>
        <th rowSpan={2} className={`${teamSeason.headerLeft} pl-3 w-[150px]`}>
          Competition
        </th>
        <th rowSpan={2} className={`${teamSeason.headerBottom} w-[80px]`}>
          LgRnk
        </th>
