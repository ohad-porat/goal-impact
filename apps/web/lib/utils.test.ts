...
describe('getShortLeagueName', () => {
  describe('Mapped league names', () => {
    it('should return "Série A" for "Campeonato Brasileiro Série A"', () => {
      expect(getShortLeagueName('Campeonato Brasileiro Série A')).toBe('Série A')
    })
  ...
  describe('Edge cases', () => {
    ...
    it('should not match when case differs (case-sensitive matching)', () => {
      expect(getShortLeagueName('campeonato brasileiro série a')).toBe('campeonato brasileiro série a')
    })

    it('should not match when input contains the league name but is longer', () => {
      expect(getShortLeagueName('Campeonato Brasileiro Série A Extra')).toBe('Campeonato Brasileiro Série A Extra')
    })
