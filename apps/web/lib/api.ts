...
export const api = {
  ...
  leagueSeasons: (leagueId: number) =>
    `${API_BASE_URL}/leagues/${leagueId}/seasons`,
  leagueTable: (leagueId: number, seasonId: number) =>
    `${API_BASE_URL}/leagues/${leagueId}/table/${seasonId}`,
  clubs: `${API_BASE_URL}/clubs/`,
  clubDetails: (clubId: number) => `${API_BASE_URL}/clubs/${clubId}`,
  teamSeasonSquad: (teamId: number, seasonId: number) =>
    `${API_BASE_URL}/clubs/${teamId}/seasons/${seasonId}`,
  teamSeasonGoalLog: (teamId: number, seasonId: number) =>
    `${API_BASE_URL}/clubs/${teamId}/seasons/${seasonId}/goals`,
  playerDetails: (playerId: number) => `${API_BASE_URL}/players/${playerId}`,
  playerGoalLog: (playerId: number) =>
    `${API_BASE_URL}/players/${playerId}/goals`,
