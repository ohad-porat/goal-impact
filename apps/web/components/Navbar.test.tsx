...
describe('Navbar', () => {
  ...
  it('should render all navigation links', () => {
    ...
    expect(screen.getByText('Nations').closest('a')).toHaveAttribute('href', '/nations')
    expect(screen.getByText('Leagues').closest('a')).toHaveAttribute('href', '/leagues')
    expect(screen.getByText('Clubs').closest('a')).toHaveAttribute('href', '/clubs')
    expect(screen.getByText('Leaders').closest('a')).toHaveAttribute('href', '/leaders')
  })
