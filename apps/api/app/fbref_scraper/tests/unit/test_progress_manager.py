...
class TestSaveScrapingProgress:
    ...
    def test_save_progress_new_file(self, tmp_path, mocker):
        ...
        mocker.patch(
            "app.fbref_scraper.core.progress_manager.SCRAPING_PROGRESS_FILE",
        ...
        with open(str(tmp_path / "progress.json")) as f:
    ...
    def test_save_progress_existing_file(self, tmp_path, mocker):
        ...
        initial_progress = {
            "existing_scraper": {"completed": False, "timestamp": "2023-01-01T00:00:00"}
        }
        ...
        mocker.patch(
            "app.fbref_scraper.core.progress_manager.SCRAPING_PROGRESS_FILE", str(progress_file)
        )
    ...
    def test_save_progress_overwrite_existing(self, tmp_path, mocker):
        ...
        initial_progress = {
            "test_scraper": {"completed": False, "timestamp": "2023-01-01T00:00:00"}
        }
...
class TestGetScrapersToRun:
    ...
    def test_get_scrapers_resume_no_progress(self, mocker):
        ...
        mocker.patch(
            "app.fbref_scraper.core.progress_manager.load_scraping_progress", return_value={}
        )
        mock_logger = mocker.patch("app.fbref_scraper.core.progress_manager.logger")
    ...
    def test_get_scrapers_resume_partial_progress(self, mocker):
        ...
        mocker.patch(
            "app.fbref_scraper.core.progress_manager.load_scraping_progress", return_value=progress
        )
        mock_logger = mocker.patch("app.fbref_scraper.core.progress_manager.logger")
        scrapers = get_scrapers_to_run(resume=True)
