...
class AllSeasonsPlayer(BaseModel):
    """Player all-seasons information."""
...
class AllSeasonsResponse(BaseModel):
    """Response for all seasons leaders."""

    top_goal_value: list[AllSeasonsPlayer]
