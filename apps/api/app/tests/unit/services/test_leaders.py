...
class TestGetCareerTotals:
    ...
    def test_returns_top_players_sorted_by_goal_value(self, db_session):
    ...
    def test_excludes_players_with_none_goal_value(self, db_session):
    ...
    def test_excludes_players_with_zero_goal_value(self, db_session):
    ...
    def test_calculates_goal_value_avg(self, db_session):
    ...
    def test_rounds_decimal_values(self, db_session):
    ...
    def test_includes_nation_info(self, db_session):
...
class TestGetBySeason:
    ...
    def test_returns_top_players_for_season(self, db_session):
    ...
    def test_aggregates_team_names(self, db_session):
    ...
    def test_handles_duplicate_team_names(self, db_session):
    ...
    def test_displays_clubs_correctly(self, db_session):
    ...
    def test_aggregates_stats_across_multiple_teams(self, db_session):
