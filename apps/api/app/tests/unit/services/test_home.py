...
class TestGetRecentImpactGoals:
    ...
    def test_filters_by_days_parameter(self, db_session):
        ...
        recent_match = MatchFactory(
            home_team=home_team, away_team=away_team, season=season, date=recent_date
        )
        old_match = MatchFactory(
            home_team=home_team, away_team=away_team, season=season, date=old_date
        )
    ...
    def test_filters_by_league_id(self, db_session):
        ...
        match_date = date.today()
        match1 = MatchFactory(
            home_team=home_team, away_team=away_team, season=season1, date=match_date
        )
        match2 = MatchFactory(
            home_team=home_team, away_team=away_team, season=season2, date=match_date
        )
