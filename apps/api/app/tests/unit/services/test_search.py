...
class TestSearchAll:
    ...
    def test_returns_empty_list_when_query_is_empty(self, db_session):
        """Test that empty list is returned when query is empty."""
        result = search_all(db_session, "")
        
        assert result == []

    def test_returns_empty_list_when_query_is_whitespace(self, db_session):
        """Test that empty list is returned when query is whitespace."""
        result = search_all(db_session, "   ")
        
        assert result == []

    def test_finds_players_by_prefix(self, db_session):
        """Test that players are found by prefix match."""
        nation = NationFactory()
        player1 = PlayerFactory(name="Alice Smith", nation=nation)
        player2 = PlayerFactory(name="Bob Johnson", nation=nation)
        player3 = PlayerFactory(name="Charlie Brown", nation=nation)
    ...
    def test_finds_players_by_contains(self, db_session):
    ...
    def test_finds_clubs_by_prefix(self, db_session):
    ...
    def test_finds_clubs_by_contains(self, db_session):
        """Test that clubs are found by contains match."""
        nation = NationFactory()
        team1 = TeamFactory(name="Manchester United", nation=nation)
        team2 = TeamFactory(name="Manchester City", nation=nation)
    ...
    def test_finds_competitions_by_prefix(self, db_session):
    ...
    def test_finds_competitions_by_contains(self, db_session):
    ...
    def test_finds_nations_by_prefix(self, db_session):
    ...
    def test_finds_nations_by_contains(self, db_session):
        """Test that nations are found by contains match."""
        nation1 = NationFactory(name="United States", country_code="USA")
    ...
    def test_prefers_prefix_over_contains(self, db_session):
    ...
    def test_limits_each_type_independently(self, db_session):
    ...
    def test_sorts_players_by_matches_played_in_prefix(self, db_session):
    ...
    def test_handles_players_without_stats(self, db_session):
    ...
    def test_returns_multiple_types(self, db_session):
    ...
    def test_handles_stripped_query(self, db_session):
