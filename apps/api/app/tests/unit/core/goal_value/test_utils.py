...
class TestCalculateOutcome:
    ...
    def test_returns_win_when_scoring_team_wins(self):
    ...
    def test_returns_loss_when_scoring_team_loses(self):
    ...
    def test_returns_draw_when_scores_equal(self):
...
class TestCalculateWindowBounds:
    ...
    def test_normal_minute_with_default_window(self):
    ...
    def test_normal_minute_with_custom_window(self):
    ...
    def test_lower_boundary_minute(self):
    ...
    def test_upper_boundary_minute(self):
    ...
    def test_window_size_larger_than_minute_range(self):
...
class TestValidateGoalData:
    ...
    def test_returns_true_for_valid_goal(self, mocker):
    ...
    def test_returns_false_when_home_pre_event_missing(self, mocker):
    ...
    def test_returns_false_when_away_pre_event_missing(self, mocker):
    ...
    def test_returns_false_when_home_post_event_missing(self, mocker):
    ...
    def test_returns_false_when_away_post_event_missing(self, mocker):
    ...
    def test_returns_false_when_match_home_goals_missing(self, mocker):
    ...
    def test_returns_false_when_match_away_goals_missing(self, mocker):
    ...
    def test_returns_false_when_match_home_goals_not_integer(self, mocker):
    ...
    def test_returns_false_when_match_away_goals_not_integer(self, mocker):
    ...
    def test_returns_true_with_all_valid_integer_values(self, mocker):
...
class TestGetScoreDiffRange:
    ...
    def test_range_has_correct_length(self):
...
class TestGetScoringTeamId:
    ...
    def test_returns_home_team_id_when_home_scored(self):
    ...
    def test_returns_away_team_id_when_away_scored(self):
    ...
    def test_returns_none_when_both_teams_scored(self):
    ...
    def test_returns_none_when_neither_team_scored(self):
    ...
    def test_returns_none_when_goals_decreased(self):
    ...
    def test_handles_negative_goal_counts(self):
