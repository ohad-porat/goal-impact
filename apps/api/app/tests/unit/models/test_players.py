...
class TestPlayerModel:
    ...
    def test_player_unique_fbref_id(self, db_session) -> None:
    ...
    def test_player_unique_fbref_url(self, db_session) -> None:
    ...
    def test_player_required_fields(self, db_session) -> None:
    ...
    def test_player_foreign_key_to_nation(self, db_session) -> None:
    ...
    def test_player_optional_nation(self, db_session) -> None:
    ...
    def test_player_cascade_behavior(self, db_session) -> None:
