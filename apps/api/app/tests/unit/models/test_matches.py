...
class TestMatchModel:
    ...
    def test_create_match(self, db_session) -> None:
    ...
    def test_match_unique_fbref_id(self, db_session) -> None:
    ...
    def test_match_unique_fbref_url(self, db_session) -> None:
    ...
    def test_match_required_fields(self, db_session) -> None:
    ...
    def test_match_foreign_keys(self, db_session) -> None:
    ...
    def test_match_optional_fields(self, db_session) -> None:
    ...
    def test_match_same_team_home_and_away(self, db_session) -> None:
