...
class TestSeasonModel:
    ...
    def test_season_year_validation_valid(self, db_session):
    ...
    def test_season_year_validation_invalid(self, db_session):
    ...
    def test_season_year_validation_equal_years(self, db_session):
    ...
    def test_season_year_validation_one_null_allowed(self, db_session):
