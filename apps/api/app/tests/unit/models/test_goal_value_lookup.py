...
class TestGoalValueLookupModel:
    ...
    def test_create_goal_value_lookup(self, db_session) -> None:
    ...
    def test_goal_value_lookup_composite_primary_key(self, db_session) -> None:
    ...
    def test_goal_value_lookup_different_combinations(self, db_session) -> None:
    ...
    def test_goal_value_lookup_required_fields(self, db_session) -> None:
    ...
    def test_goal_value_lookup_repr(self, db_session) -> None:
