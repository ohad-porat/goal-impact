...
from app.core.goal_value import (
...
def main():
    ...
    parser.add_argument(
        "--calculate-goal-value", action="store_true", help="Calculate goal value statistics"
    )
    parser.add_argument(
        "--update-goal-values",
        action="store_true",
    ...
    parser.add_argument(
        "--show-sample-sizes", action="store_true", help="Show sample sizes organized by minute"
    )
    parser.add_argument(
        "--minute", type=int, metavar="N", help="Show detailed sample sizes for specific minute N"
    )
    parser.add_argument(
        "--window-size",
        type=int,
    ...
    parser.add_argument(
        "--score-diff", type=int, metavar="N", help="Show sample sizes for specific score_diff N"
    )
    parser.add_argument(
        "--show-goal-details",
        action="store_true",
