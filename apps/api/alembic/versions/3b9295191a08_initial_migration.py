...
Revision ID: 3b9295191a08
Revises: 
Create Date: 2025-10-12 00:26:35.515043
...
def upgrade() -> None:
    ...
    sa.Column('points_added', sa.Float(), nullable=True),
    sa.Column('goal_value', sa.Float(), nullable=True),
    sa.Column('pa_avg', sa.Float(), nullable=True),
